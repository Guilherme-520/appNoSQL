...
fun addDataToDatabase(
    ...
    fun readCourses(dbHandler: DBHandler): ArrayList<CourseModel>? {
        return dbHandler.readCourses()
    }

    // Update function
    fun updateCourse(dbHandler: DBHandler, courseId: Int, courseName: String, courseDuration: String, courseDescription: String, courseTracks: String): Int {
        return dbHandler.updateCourse(courseId, courseName, courseDuration, courseDescription, courseTracks)
    }

    // Delete function
    fun deleteCourse(dbHandler: DBHandler, courseId: Int): Boolean {
        return dbHandler.deleteCourse(courseId)
    }
